...
Date.prototype.dst = function() {
    return this.getTimezoneOffset() < this.stdTimezoneOffset();
          ...
          window.onload = function () {
				...
				//$('.countdown-inner-top').responsiveText({maxWidth: 500});
				...
				/*           $('#seconds .countdown-inner-bottom').css('color',secondsColour);
								$('#minutes .countdown-inner-bottom').css('color',minutesColour);
								$('#hours .countdown-inner-bottom').css('color',hoursColour);
								$('#days .countdown-inner-bottom').css('color',daysColour);*/
				...
				/*sec_arc.animate({
								arc: [halfScale, halfScale, secondsPlace, 100, timerScale]
				}, 1500, "linear");                                                              */
				...
				/*min_arc.animate({
								...
								//timeDiff = timeDiff + serverTimeDiff;
								//console.log(124);
								if (timeDiff <= 0) {
				...
				/*function cdtd () {
								var xmas = new Date("December 25, 2013 00:01:00");
								var now = new Date();
			   ...
			   //function theLoop(){cdtd(); ticTimers();}
